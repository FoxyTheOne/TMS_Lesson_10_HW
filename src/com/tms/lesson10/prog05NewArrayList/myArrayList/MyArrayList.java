 ...
 *
 * Для большей правильности для коллекции надо определить интерфейс(т.е. задать поведение коллекции)
 * и уже потом в конкретном классе реализовывать методы коллекции
 * как List и ArrayList
 */
public class MyArrayList<S> implements IListOfMine {
    // Поля
